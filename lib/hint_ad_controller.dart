...
class HintAdController extends ChangeNotifier {
  HintAdController({
    bool? integrationEnabled,
    Duration adDuration = const Duration(seconds: 5),
  })  : _integrationEnabled =
            integrationEnabled ?? const bool.fromEnvironment('enableHintAd'),
  ...
  Future<bool> _performShowAd(BuildContext context) async {
    ...
    await showDialog<void>(
      ...
      builder: (context) {
        ...
        return _HintAdDialog(
          duration: _adDuration,
          title: l10n.hintAdTitle,
          description: l10n.hintAdDescription,
          countdownBuilder: l10n.hintAdCountdown,
        );
      },
    );
...
class _HintAdDialog extends StatefulWidget {
  const _HintAdDialog({
  ...
  @override
  State<_HintAdDialog> createState() => _HintAdDialogState();
}

class _HintAdDialogState extends State<_HintAdDialog> {
