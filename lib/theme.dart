...
final Map<SudokuTheme, _ThemeConfig> _themeConfigs = {
  ...
  SudokuTheme.black: _ThemeConfig(
    ...
    background: const Color(0xFF06080E),
    surface: const Color(0xFF121620),
    primary: const Color(0xFF3B82F6),
    onPrimary: Colors.white,
    onSurface: const Color(0xFFE8ECF8),
    outline: const Color(0xFF27324B),
    outlineVariant: const Color(0xFF1C2336),
    colors: const SudokuColors(
      boardInner: Color(0xFF0F1420),
      boardBorder: Color(0xFF23304B),
      selectedCell: Color(0xFF1E2F49),
      sameNumberCell: Color(0xFF172338),
      noteColor: Color(0xFF8CA4D2),
      headerButtonBackground: Color(0xFF181F2E),
      ...
      numberPadBackground: Color(0xFF121620),
      numberPadBorder: Color(0xFF1C2336),
      numberPadSelectedBackground: Color(0xFF1E2E4A),
      numberPadSelectedBorder: Color(0xFF3B82F6),
      numberPadHighlightBackground: Color(0xFF18233A),
      numberPadHighlightBorder: Color(0xFF4361A8),
      numberPadDisabledBackground: Color(0xFF0C101B),
      numberPadDisabledText: Color(0xFF394463),
      numberPadRemaining: Color(0xFF5F6B8B),
  ...
  SudokuTheme.purple: _ThemeConfig(
    brightness: Brightness.dark,
    background: const Color(0xFF24103D),
    surface: const Color(0xFF2F1851),
    primary: const Color(0xFF9F7AEA),
    onPrimary: Colors.white,
    onSurface: const Color(0xFFEADFFF),
    outline: const Color(0xFF412D60),
    outlineVariant: const Color(0xFF35214F),
    colors: const SudokuColors(
      boardInner: Color(0xFF2B1547),
      boardBorder: Color(0xFF4A2F72),
      selectedCell: Color(0xFF44286D),
      sameNumberCell: Color(0xFF39225A),
      noteColor: Color(0xFFBFA7DA),
      headerButtonBackground: Color(0xFF351F59),
      headerButtonIcon: Color(0xFFB99CFF),
      actionButtonActiveBackground: Color(0xFF44296D),
      actionButtonActiveBorder: Color(0xFF9F7AEA),
      actionButtonBadgeColor: Color(0xFFB99CFF),
      numberPadBackground: Color(0xFF2F1851),
      numberPadBorder: Color(0xFF3A245F),
      numberPadSelectedBackground: Color(0xFF44296D),
      numberPadSelectedBorder: Color(0xFFB99CFF),
      numberPadHighlightBackground: Color(0xFF3A245F),
      numberPadHighlightBorder: Color(0xFF845FD3),
      numberPadDisabledBackground: Color(0xFF23123B),
      numberPadDisabledText: Color(0xFF6E5A8C),
      numberPadRemaining: Color(0xFFA287C6),
