...
final Map<SudokuTheme, _ThemeConfig> _themeConfigs = {
  SudokuTheme.white: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x55EAF2F8),
      crosshairHighlight: Color(0x4FD6EAF8),
  ...
  SudokuTheme.cream: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x55F8EBD6),
      crosshairHighlight: Color(0x4FFDF5E6),
  ...
  SudokuTheme.green: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x55ECF7F0),
      crosshairHighlight: Color(0x4FEFF9F3),
  ...
  SudokuTheme.black: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x552B374C),
      crosshairHighlight: Color(0x4F252F41),
