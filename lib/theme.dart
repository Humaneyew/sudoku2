...
final Map<SudokuTheme, _ThemeConfig> _themeConfigs = {
  SudokuTheme.white: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x45EAF2F8),
      crosshairHighlight: Color(0x40D6EAF8),
  ...
  SudokuTheme.cream: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x45F8EBD6),
      crosshairHighlight: Color(0x40FDF5E6),
  ...
  SudokuTheme.green: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x45ECF7F0),
      crosshairHighlight: Color(0x40EFF9F3),
  ...
  SudokuTheme.black: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x452B374C),
      crosshairHighlight: Color(0x40252F41),
