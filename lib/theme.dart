...
final Map<SudokuTheme, _ThemeConfig> _themeConfigs = {
  ...
  SudokuTheme.cream: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x66BEE8D4),
      crosshairHighlight: Color(0x5FA3D9C2),
  ...
  SudokuTheme.green: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x66A7E6D6),
      crosshairHighlight: Color(0x5F8FD7C3),
  ...
  SudokuTheme.black: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x66A0C2FF),
      crosshairHighlight: Color(0x5F8BB5F0),
