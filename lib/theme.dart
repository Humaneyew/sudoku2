...
final Map<SudokuTheme, _ThemeConfig> _themeConfigs = {
  SudokuTheme.white: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x4DEAF2F8),
      crosshairHighlight: Color(0x48D6EAF8),
  ...
  SudokuTheme.cream: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x4DF8EBD6),
      crosshairHighlight: Color(0x48FDF5E6),
  ...
  SudokuTheme.green: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x4DECF7F0),
      crosshairHighlight: Color(0x48EFF9F3),
  ...
  SudokuTheme.black: _ThemeConfig(
    ...
    colors: const SudokuColors(
      ...
      blockHighlight: Color(0x4D2B374C),
      crosshairHighlight: Color(0x48252F41),
